...
class Config(object):
    ...
    BLACK_IMG = getenv("BLACK_IMG", "https://telegra.ph/file/9eff0c0f0fc78f9724dea.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "\x40\x4d\x75\x73\x69\x63\x5f\x48\x65\x6c\x6c\x42\x6f\x74")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://te.legra.ph/file/d6caa6ac0550bd1719af0.jpg")           # put direct link to image here
    ...
    TELEGRAM_IMG = getenv("https://te.legra.ph/file/d6caa6ac0550bd1719af0.jpg", None)         # put direct link to image here
